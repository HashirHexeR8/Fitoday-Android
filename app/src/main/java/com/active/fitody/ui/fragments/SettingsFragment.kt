...
import com.active.fitody.databinding.FragmentSettingsBinding
import com.active.fitody.databinding.LayoutSettingsListButtonItemBinding
import com.active.fitody.databinding.LayoutSettingsListItemBinding
import com.active.fitody.databinding.LayoutSettingsListShopButtonItemBinding
import com.active.fitody.ui.activity.IntroLoginActivity
import com.active.fitody.model.settingsListItemDTO
...
class SettingsFragment: Fragment(), SettingsListRecyclerViewAdapter.ItemClickListener {
    ...
    override fun logoutButtonClicked() {
        UserPrefs.getInstance().putUserLoggedIn(false)
        UserPrefs.getInstance().putUserId(0)
